...
<div class="container" style="margin-top: 70px;">
    ...
    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
            ...
            <!-- SOURCE NYA DARI EDIT.PHP -->
                <div class="input-group mb-3">
                    <div class="input-group-prepend" <?php if (isset($name_error)): ?> class="form_error" <?php endif ?>>
                        <span class="input-group-text" id="inputGroup-sizing-default">home_text1 &nbsp; <div style="color:red">*</div></span>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend"  <?php if (isset($name_error)): ?> class="form_error" <?php endif ?>>
                        <span class="input-group-text" id="inputGroup-sizing-default">home_text2 &nbsp; <div style="color:red">*</div></span>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend" <?php if (isset($name_error)): ?> class="form_error" <?php endif ?>>
                        <span class="input-group-text" id="inputGroup-sizing-default">home_text3 &nbsp; <div style="color:red">*</div></span>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend" <?php if (isset($name_error)): ?> class="form_error" <?php endif ?>>
                        <span class="input-group-text" id="inputGroup-sizing-default">home_text4 &nbsp; <div style="color:red">*</div></span>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend" <?php if (isset($name_error)): ?> class="form_error" <?php endif ?>>
                        <span class="input-group-text" id="inputGroup-sizing-default">home_text5 &nbsp; <div style="color:red">*</div></span>
                    </div>
